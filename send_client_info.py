...
def main():
    ...
    MSSQL_DATABASE_CONNECTION.setdecoding(pyodbc.SQL_CHAR, encoding='utf8')
    MSSQL_DATABASE_CONNECTION.setdecoding(pyodbc.SQL_WCHAR, encoding='utf8')
    MSSQL_DATABASE_CONNECTION.setencoding(encoding='utf8')
